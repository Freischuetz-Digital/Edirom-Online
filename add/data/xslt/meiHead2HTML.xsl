    ...
    <xsl:template match="mei:work" name="work">
        ...
        <xsl:element name="div">
            ...
            <xsl:element name="div">
                ...
                <xsl:apply-templates select="mei:titleStmt"/>
                <xsl:apply-templates select="mei:pubStmt"/>
                <xsl:if test="mei:langUsage | mei:editionStmt | mei:classification"><!-- TODO test -->
                    <xsl:element name="div">
                        <xsl:attribute name="class">section</xsl:attribute>
                        <xsl:call-template name="rendToSection">
                        ...
                        <xsl:element name="div">
                            ...
                            <xsl:apply-templates select="mei:langUsage | mei:editionStmt | mei:classification" mode="plainCommaSep"/>
                        </xsl:element>
                    </xsl:element>
                </xsl:if>
